...
class ManagerPegawaiController extends Controller
{
    public function index()
    {
        $pegawais = Pegawai::orderBy('id_pegawai')->paginate(10);
        return view('levelManager/pegawai.index', compact('pegawais'));
    }

    public function create()
    {
        return view('levelManager/pegawai.create');
    }
    ...
    public function show($id_pegawai)
{
    ...
    return view('levelManager/pegawai.show', compact('pegawai'));
}

public function edit($id_pegawai)
{
    $dataPegawai = Pegawai::findOrFail($id_pegawai);
    return view('levelManager/pegawai.edit', compact('dataPegawai'));
}
