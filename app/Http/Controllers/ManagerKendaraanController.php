...
class ManagerKendaraanController extends Controller
{
    public function index()
    {
        $datakendaraan = Kendaraan::all();
        return view('levelManager/kendaraan.index', compact('datakendaraan'));
    }

    public function create()
    {
        return view('levelManager/kendaraan.create');
    }
    ...
    public function edit($no_pol)
{
    try {
        ...
        return view('levelManager/kendaraan.edit', compact('kendaraan'));
    } catch (\Exception $e) {
...
public function update(Request $request, $no_pol)
{
    ...
    {
        $kendaraan = Kendaraan::findOrFail($id);
        return view('levelManager/kendaraan.show', compact('kendaraan'));
    }
}
