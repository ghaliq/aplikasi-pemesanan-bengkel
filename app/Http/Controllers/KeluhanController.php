...
class KeluhanController extends Controller
{
    public function index()
    {
        ...
        return view('levelAdmin/keluhan.index', compact('keluhans'));
    }
    ...
    public function create()
    {
        ...
        return view('levelAdmin/keluhan.create', compact('customers', 'kendaraans', 'pegawais'));
    }
    ...
    public function edit($id_keluhan)
    {
        ...
        $kendaraans = Kendaraan::all();
        $pegawais = Pegawai::all();
        return view('levelAdmin/keluhan.edit', compact('keluhan', 'customers', 'kendaraans', 'pegawais'));
    }
    ...
    public function update(Request $request, $id_keluhan)
    {
        ...
        return redirect()->route('levelAdmin/keluhan.index')->with('success', 'Keluhan berhasil diperbarui.');
    }
