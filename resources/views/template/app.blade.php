...
<head>
  ...
  <title>Dashboard Aplikasi Pemesanan Bengkel</title>
      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="#">Aplikasi Pemesanan Bengkel</a>
          </div>
          ...
          <ul class="sidebar-menu">
            <li class="menu-header">
              <i class="fas fa-landmark"></i><span> Menu Utama</span>
            </li>
            <li class="nav-item{{ request()->is('customer') ? ' active' : '' }}">
              <a href="{{ url('levelAdmin/customer') }}"><i class="fas fa-user-friends"></i><span> Customer</span></a>
            </li>
            <li class="nav-item{{ request()->is('barang') ? ' active' : '' }}">
              <a href="{{ url('levelAdmin/barang') }}"><i class="fas fa-box"></i><span> Barang</span></a>
            </li>
            <li class="nav-item{{ request()->is('keluhan') ? ' active' : '' }}">
              <a href="{{ url('levelAdmin/keluhan') }}"><i class="fas fa-exclamation-circle"></i><span> Keluhan</span></a>
            </li>
            <li class="nav-item{{ request()->is('kendaraan') ? ' active' : '' }}">
              <a href="{{ url('levelAdmin/kendaraan') }}"><i class="fas fa-car"></i><span> Kendaraan</span></a>
            </li>
            <li class="nav-item{{ request()->is('pegawai') ? ' active' : '' }}">
              <a href="{{ url('levelAdmin/pegawai') }}"><i class="fas fa-user-tie"></i><span> Pegawai</span></a>
            </li>
            <li class="nav-item{{ request()->is('supplier') ? ' active' : '' }}">
              <a href="{{ url('levelAdmin/supplier') }}"><i class="fas fa-truck"></i><span> Supplier</span></a>
            </li>
          </ul>
          ...
          {{-- <div class="main-sidebar sidebar-style-2">
            <aside id="sidebar-wrapper">
              ...
              <ul class="sidebar-menu">
                ...
                @include('template.sidebarPelanggan')
                @endif 
              </ul>
              </li>
              </ul>
     --}}
      ...
      <footer class="main-footer">
        <div class="footer-left">
          Copyright &copy; 2024 <div class="bullet"></div> Design By <a href="https://nauval.in/">Ghaliq Candri Haki</a>
        </div>
